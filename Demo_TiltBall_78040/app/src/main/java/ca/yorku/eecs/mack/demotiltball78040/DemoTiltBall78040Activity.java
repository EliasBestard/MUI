...
public class DemoTiltBall78040Activity extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        lapNumbers = b.getInt("lapNumbers");
        experiment_mode = b.getInt("experiment_mode");
//        experiment_mode ="Game";
        if(experiment_mode==0)
            Log.i(MYDEBUG, "AAAAAAAAAAAAAAAA");
        ...
        rb.configure(pathType, pathWidth, gain, orderOfControl, lapNumbers,experiment_mode);
